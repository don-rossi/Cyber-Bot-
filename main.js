...
global.channelLink = "https://whatsapp.com/channel/0029Va425593742170";
global.ytch = "CyberTech";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Va425593742170'
                }, { quoted: message });
                return;
        ...
        if (isBanned(senderId) &&!userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '❌ You are banned from using ⚡CyberBot⚡. Contact an admin to get unbanned.',
                   ...channelInfo
                });
            }
            return;
        ...
        /* // Basic message response in private chat
          if (!isGroup && (userMessage === 'hi' || userMessage === 'hello' || userMessage === 'bot' || userMessage === 'hlo' || userMessage === 'hey' || userMessage === 'bro')) {
              await sock.sendMessage(chatId, {
                  text: 'Hi, I am ⚡CyberBot⚡. How can I help you?\nYou can use.menu for more info and commands.',
                 ...channelInfo
              });
              return;
          } */
        ...
        const ownerCommands = ['.mode', '.autostatus', '.antidelete', '.cleartmp', '.setpp', '.clearsession', '.areact', '.autoreaction', '.autotyping', '.autoread', '.pmblocker'];
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { text: 'Please make ⚡CyberBot⚡ an admin to use admin commands.',...channelInfo }, { quoted: message });
                return;
            }
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.mode'):
                ...
                try {
                    ...
                    await sock.sendMessage(chatId, { text: `⚡CyberBot⚡ is now in *${action}* mode`,...channelInfo });
                } catch (error) {
            ...
            case userMessage.startsWith('.antilink'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: 'Please make ⚡CyberBot⚡ an admin first.',
                       ...channelInfo
                    }, { quoted: message });
                    return;
                }
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { text: '*⚡CyberBot⚡ must be admin to use this feature*',...channelInfo }, { quoted: message });
                    return;
                }
